        ...
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <i data-feather="home" class="report-box__icon text-primary"></i>
                                    </div>
                                    <div class="text-2xl font-medium leading-8 mt-6">Lohegaon</div>
                                    <div class="text-base text-slate-500 mt-1">Address</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <i data-feather="phone" class="report-box__icon text-pending"></i>
                                    </div>
                                    <div class="text-2xl font-medium leading-8 mt-6">9999813409</div>
                                    <div class="text-base text-slate-500 mt-1">Contact</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        <i data-feather="mail" class="report-box__icon text-warning"></i>
                                    </div>
                                    <div class="text-2xl font-medium leading-8 mt-6">pulkitaggarwal200@gmail.com</div>
                                    <div class="text-base text-slate-500 mt-1">Email</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-2xl font-medium leading-8 mt-6">No</div>
                                    <div class="text-base text-slate-500 mt-1">Currently Diagonosed</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-12 mt-6">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Allergies</h2>
                    </div>
                    <div class="intro-y overflow-auto lg:overflow-visible mt-8 sm:mt-0">
                        <table class="table table-report sm:mt-2">
                            <thead>
                                <tr>
                                    <th class="whitespace-nowrap">ALLERGEN</th>
                                    <th class="text-center whitespace-nowrap">SEVERITY</th>
                                    <th class="text-center whitespace-nowrap">ATTACKS</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="intro-x">
                                    <td class="font-medium whitespace-nowrap">Allegen 01</td>
                                    <td class="text-center">Grade 01</td>
                                    <td class="text-center">02</td>
                                </tr>
                                <tr class="intro-x">
                                    <td class="font-medium whitespace-nowrap">Allegen 02</td>
                                    <td class="text-center">Grade 04</td>
                                    <td class="text-center">04</td>
                                </tr>
                                <tr class="intro-x">
                                    <td class="font-medium whitespace-nowrap">Allegen 03</td>
                                    <td class="text-center">Grade 02</td>
